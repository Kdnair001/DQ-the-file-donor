...
class Database:
    ...
    async def total_users_count(self):
        return (await self.col.count_documents({})) + (await self.col2.count_documents({}))
    ...
    async def get_all_users(self):
        return (await self.col.find({}).to_list(None)) + (await self.col2.find({}).to_list(None))
    ...
    async def total_chat_count(self):
        return (await self.grp.count_documents({})) + (await self.grp2.count_documents({}))


    async def get_all_chats(self):
        return (await self.grp.find({}).to_list(None)) + (await self.grp2.find({}).to_list(None))
